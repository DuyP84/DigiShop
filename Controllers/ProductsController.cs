...
namespace DigiShop.Controllers
{
    public class ProductsController : Controller
    {
        ...
        //SEARCH : Products
        [HttpPost]
        public async Task<IActionResult> SearchByName(string keywords, int productPage = 1)
        {
            return View("Index",
        ...
        [HttpGet]
        [HttpPost]
        public async Task<IActionResult> ProductsByCategory(int categoryId, int productPage = 1)
        {
            ...
            return View("Index",
                new ProductListViewModel
                {
                    ...
                    PagingInfo = new PagingInfo
                    {
                        ItemsPerPage = PageSize,
                        CurrentPage = productPage,
                        TotalItems = _context.Products.Count(p => p.CategoryId == categoryId)
